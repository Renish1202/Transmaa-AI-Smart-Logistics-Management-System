...
RIDE_PRICE_PER_KM = float(os.getenv("RIDE_PRICE_PER_KM", "25"))
RIDE_MINIMUM_FARE = float(os.getenv("RIDE_MINIMUM_FARE", "300"))
RIDE_PRICING_CURRENCY = os.getenv("RIDE_PRICING_CURRENCY", "INR")
RIDE_GEO_TIMEOUT_SECONDS = float(os.getenv("RIDE_GEO_TIMEOUT_SECONDS", "8"))
RIDE_ROUTE_TIMEOUT_SECONDS = float(os.getenv("RIDE_ROUTE_TIMEOUT_SECONDS", str(RIDE_GEO_TIMEOUT_SECONDS)))
RIDE_ROUTING_ENDPOINT = os.getenv("RIDE_ROUTING_ENDPOINT", "https://router.project-osrm.org/route/v1/driving").strip()
